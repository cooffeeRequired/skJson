...
import static cz.coffee.core.Utils.isIncrementNumber;
import static cz.coffee.core.Utils.isNumeric;
import static cz.coffee.core.utils.JsonUtils.fromPrimitive2Object;
import static cz.coffee.core.utils.JsonVariables.*;
...
public class JsonMapping {
    ...
    private static Object jsonListSubTree(String name, boolean isLocal, Event event) {
        ...
        if (!(variable instanceof String || variable instanceof Number || variable instanceof Boolean || variable instanceof JsonElement || variable instanceof Map || variable instanceof List)) {
            variable = DefaultAdapter.parse(variable, event);
        }
        return variable;
    }
